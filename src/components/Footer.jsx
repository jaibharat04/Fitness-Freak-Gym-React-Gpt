    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* About Us Section */}
          <div>
            <h3 className="text-2xl font-bold">About Fitness Freak Gym</h3>
            <p className="mt-4 text-gray-300">
              Fitness Freak Gym is your ultimate fitness destination. We offer a
          ...
          <div>
            ...
            <p className="mt-4 text-gray-300">
              ...
              Phone: (123) 456-7890
              <br />
              Email: info@fitnessfreakgym.com
            </p>
          </div>
        ...
        <div className="mt-8 border-t border-gray-700 pt-8 text-center text-gray-400">
          <p>&copy; 2024 Fitness Freak Gym. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
