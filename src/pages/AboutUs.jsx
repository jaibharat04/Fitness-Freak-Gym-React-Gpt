        ...
        <section className="max-w-7xl mx-auto">
          ...
          <div className="space-y-12">
            ...
            <div>
              ...
              <p className="text-lg">
                At FITNESS FREAK GYM, our mission is to empower individuals to
            ...
            <div>
              ...
              <p className="text-lg">
                FITNESS FREAK GYM was founded in [Year] with the goal of
            ...
            <div className="text-center mt-12">
              ...
              <p className="text-lg mt-4">
                ...
                gym, meet our team, and see for yourself why FITNESS FREAK GYM
